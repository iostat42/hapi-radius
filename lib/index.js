...
exports.register = function (server, options, next) {
    ...
    // validate options
    Joi.validate(options, internals.schemas.client, function (err, clientOptions) {
        ...
        internals.accessRequest = internals.createAccessRequest(clientOptions);

        // radius client options
        internals.clientOptions = internals.createClientOptions(clientOptions);
